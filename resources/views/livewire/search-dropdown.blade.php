<div class="relative" x-data="{ isVisible: true }" @click.outside="isVisible = false">
    <input wire:model.debounce.150ms="search" wire:keyup="loadSearchResults" type="text" name="query"
        aria-label="Search games" class="w-64 px-3 py-1 pl-8 text-sm bg-gray-800 rounded-full"
    ...
    @if (strlen($search) > 2)
        <div class="absolute z-50 w-64 mt-2 text-xs bg-gray-800 rounded" aria-live="polite" x-show="isVisible"
